...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("1.Land Dino /n 2.Aqua Dino /n 3.Aerial Dino");
	...
	/*	float locomotionSpeed=sc.nextFloat();
		...
		//LavaDino land=new LavaDino(species,locomotionType,locomotionSpeed,numberOfWings,
			//	speedPerWing,ashResistance,numberOfFins,numberOfTails,lavaMultiplier,numberOfLegs);
